...
\begin{proof}
\item[(a)] Let $\varphi$ the restriction of the signature $\mathrm{sgn}$ to $(S_3 \wr S_2) \cap A_6$:
$$
\varphi \left\{
\begin{array}{ccc}
S_3 \wr S_2 & \to & \{-1,1\}\\
...
$\bullet$ Since $|(S_3 \wr S_2) \cap A_6 \times \langle \sigma \rangle | = |S_3\wr S_2|$, $\varphi$ is a bijection, thus is a group isomorphism.
