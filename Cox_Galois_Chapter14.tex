...
Conversely, let $G$ be a transitive Abelian subgroup of $S_n$, where $n$ is composite. By part (a), $|G| = n$. We must prove that $G$ is imprimitive.
...
To conclude, $G$ is primitive if and only if $|G|$ is prime. Thus a transitive Abelian permutation group is imprimitive unless it is cyclic of prime order.
