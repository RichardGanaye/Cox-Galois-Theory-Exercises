...
From Ex.13.3.4 $$\Theta_f(y)=\prod_{i=1}^3 ( y^2 - \varphi_i) ,$$ where $\varphi_i=\Delta(f)(4y_i+c_1^2-4c_2)$, $y_1=\alpha_1\alpha_2+\alpha_3\alpha_4,y_2=\alpha_1\alpha_3+\alpha_2\alpha_4,y_3=\alpha_1\alpha_4+\alpha_2\alpha_3$ and $\varphi_1=(\sqrt{\Delta(f)}(\alpha_1+\alpha_2-\alpha_3-\alpha_4))^2,~ f=x^4-c_1x^3+c_2x^2-c_3x+c_4,~\alpha_1,...,\alpha_4$ roots of $f$.
\be
\item[(a)] Since $\varphi_2=(23)\varphi_1$, $\varphi_3=(34)\varphi_2$, $\varphi_1=(24)\varphi_3$ and $\varphi_2=(123)\varphi_1$,~$\varphi_3=(134)\varphi_2$,~$\varphi_1=(324)\varphi_3$, both $A_4$ and $S_4$ act transitively on $\varphi_i$.
Hence, in case when Galois group $G_f$ is $A_4$ or $S_4$, then $\Theta_f(y)$ is irreducible over $F$. 

\item[(b)] Since $\varphi_1=(1324)\varphi_1=(12)\varphi_1$ and $\sqrt{\varphi_1}=-(12)\sqrt{\varphi_1}$, the root $\varphi_1$ is fixed by $G_f=\langle (1324),(12) \rangle$, but $\sqrt{\varphi_1}$ isn't,  therefore $\varphi_1 \in F$ and $\varphi_1 \notin F^2$. Hence, $g(y)=(y^2-\varphi_1) \in F[x]$ is degree 2 and irreducible over $F$.

Since, $\varphi_3=(1324)\varphi_2=(12)\varphi_2$, $\varphi_2=(1324)\varphi_3=(12)\varphi_3$ and $\varphi_2+\varphi_3=(12)(\varphi_2+\varphi_3)=(1324)(\varphi_2+\varphi_3)$, $\varphi_2\varphi_3=(12)(\varphi_2\varphi_3)=(1324)(\varphi_2\varphi_3)$, the roots $\varphi_2,\varphi_3 \notin F$, but $\varphi_2+\varphi_3,\varphi_2\varphi_3 \in F$. Hence, $h(y)=(y^2-\varphi_2)(y^2-\varphi_3)=(y^4-(\varphi_2+\varphi_3)y^2+\varphi_2\varphi_3)\in F[x]$  is degree 4 and irreducible over $F$.

Thus, $\Theta_f(y)=g(y)h(y)$, where $g(y),h(y)\in F[x]$ are irreducible of degree 2 and 4 respectively.

\item[(c)] Since, $\varphi_i=(12)(34)\varphi_i=(13)(24)\varphi_i$ for all $i=1,2,3$ and $\sqrt{\varphi_1}=-(13)(24)\sqrt{\varphi_1}$,$\sqrt{\varphi_i}=-(12)(34)\sqrt{\varphi_i}$, $i=2,3$, the roots $\varphi_i$ are fixed by $G_f=\langle (12)(34),(13)(24) \rangle$, but $\sqrt{\varphi_i}$ aren't,  therefore, $\varphi_i \in F$ and $\varphi_i \notin F^2$ for all $i=1,2,3$. 

Thus, $\Theta_f(y)=g_1(y)g_2(y)g_3(y)$, where $g_i(y)=( y^2 - \varphi_i)\in F[x]$, $i=1,2,3$, are irreducible of degree 2.
\item[(d)] Since  $\sqrt{\varphi_1}=(1324)\sqrt{\varphi_1}$, the root $\sqrt{\varphi_1}$ is fixed by $G_f=\langle (1324) \rangle$, therefore $\sqrt{\varphi_1} \in F$. Hence, $g_1(y)=(y-\sqrt{\varphi_1}),g_2(y)=(y+\sqrt{\varphi_1}) \in F[x]$ are degree 1. By the same reasons as in part (b), $g_3(y)=(y^4-(\varphi_2+\varphi_3)y^2+\varphi_2\varphi_3)\in F[x]$  is degree 4 and irreducible over $F$.

Thus, $\Theta_f(y)=g_1(y)g_2(y)g_3(y)$, where $g_i(y)\in F[x]$, $i=1,2,3$, are irreducible of degree 1,1 and 4 respectively.

\item[(e)] Using $\Theta_f(y)$ and $\Delta(f)$, we may identify how $\Theta_f(y)$ can be factorized in field $F$ and, depending on which case from (a) to (d) is applicable, the Galois group $G_f$ may be determined. Since $G_f$ depends on the enumeration of roots of $f$, $G_f$ can be identified up to conjugacy. 
\ee\end{proof}
}
...
{\it In the proof of Proposition 13.3.9, we showed that when $GL(3,\mathbb{F}_2) \subset S_7$ acts on three-element subsets of {1,...,7}, the orbits have lengths 7 and 28. We also asserted that up to conjugacy, $GL(3,\mathbb{F}_2)$ is the only subgroup of $S_7$ with this property. In this exercise, you will study the action of some other subgroups of $S_7$.
\be
\item[(a)] Prove that $A_7$ and $S_7$ act transitively on three-element subsets of {1,...,7}. Thus there is one orbit of length 35 for these groups.
\item[(b)] In Section 13.2, the group $AGL(1,\mathbb{F}_5) \subset S_5$ played an important role in understanding the Galois group of a quintic. In a similar way, we have $AGL(1,\mathbb{F}_7) \subset S_7$ provided we think of the indices as congruences classes modulo 7. Prove that the orbits of $AGL(1,\mathbb{F}_7)$ acting on the triples {0,1,2} and {0,1,3} have 21 and 14 elements, respectively.
\ee

\begin{proof}
\be
\item[(a)] An action of a group G on a set of three-elements subsets of 1,...,7 is transitive when, for all triples of distinct elements $i,j,k$ and $i',j',k'$, there is a $g\in G$ such that $i'=g(i),j'=g(j),k'=g(k)$.

The distinctness of elements means $i\ne i'$ and $j\ne j'$ and $k\ne k'$. The possibility $i=i'$ (or $j'$ or $k'$) or $j=j'$ (or $i'$ or $k'$) or $k=k'$ (or $i'$ or $j'$) is allowed. 

$\bullet$ Case when two triples of distinct numbers have no elements in common. We might write the triples as (1,2,3) and (4,5,6). Then odd permutation (14)(25)(36)$\in S_n$ and even permutation (147)(25)(36)$\in A_n$ takes the first triple to the second.

$\bullet$ Case when two triples have one elements in common. We might write the triples as (1,2,3) and (1,5,6). Then odd permutation (257)(36)$\in S_n$ and even permutation (25)(36)$\in A_n$ sends the first triple to the second.

$\bullet$ Case when two triples have two elements in common. We might write the triples as (1,2,3) and (1,2,6). Then odd permutation (36)$\in S_n$ and even permutation (367)$\in A_n$ sends the first triple to the second.
...
\begin{proof}
\be
\item[(a)] Since for any $\tau,\sigma \in A_n$ we have $\tau\sigma \in A_n$, then $$\tau\cdot D=\sum_{\sigma \in A_n} \tau\sigma \cdot x_1^{n-1}x_2^{n-2} \dots x_{n-2}^2x_{n-1}=\sum_{\sigma' \in A_n} \sigma' \cdot \prod_{i=1}^n x_i^{n-i}=D.$$
Thus, $A_n$ is the symmetry group of D.
\item[(b)] Applying Leibniz formula that for any $n\times n$ matrix A with $a_{ij}$ as an entry in $i$-th row and $j$-th column 
$$det(A)=\sum_{\sigma \in S_n}sgn(\sigma)  \prod_{i=1}^n a_{\sigma(i),j}$$
we have 
\begin{align*}
 D-D' & =\sum_{\sigma \in A_n} \sigma \cdot \prod_{i=1}^n x_i^{n-i}-(12)\sum_{\sigma \in A_n} \sigma \cdot \prod_{i=1}^n x_i^{n-i} \\
& = \sum_{\sigma \in A_n} \sigma \cdot \prod_{i=1}^n x_i^{n-i}-\sum_{\sigma \in S_n \setminus A_n} \sigma \cdot \prod_{i=1}^n x_i^{n-i}\\
& = \sum_{\sigma \in S_n}sgn(\sigma) \sigma \cdot \prod_{i=1}^n x_i^{n-i} \\
& = \sum_{\sigma \in S_n}sgn(\sigma)  \prod_{i=1}^n x_{\sigma(i)}^{n-i} \\
& = 
\begin{vmatrix}
...
& = \prod_{1\leq i<j\leq n}(x_i-x_j) 
 = \sqrt \Delta
\end{align*}
\item[(c)] Similar to part (b):
\begin{align*}
 D+D' & =\sum_{\sigma \in A_n} \sigma \cdot \prod_{i=1}^n x_i^{n-i}+(12)\sum_{\sigma \in A_n} \sigma \cdot \prod_{i=1}^n x_i^{n-i} \\
& = \sum_{\sigma \in A_n} \sigma \cdot \prod_{i=1}^n x_i^{n-i}+\sum_{\sigma \in S_n \setminus A_n} \sigma \cdot \prod_{i=1}^n x_i^{n-i}\\
& = \sum_{\sigma \in S_n} \sigma \cdot \prod_{i=1}^n x_i^{n-i} \\
 DD' & =\sum_{\sigma \in A_n} \sigma \cdot \prod_{i=1}^n x_i^{n-i}\times(12)\sum_{\sigma \in A_n} \sigma \cdot \prod_{i=1}^n x_i^{n-i} \\
& = \sum_{\sigma \in A_n} \sigma \cdot \prod_{i=1}^n x_i^{n-i}\times\sum_{\sigma \in S_n \setminus A_n} \sigma \cdot \prod_{i=1}^n x_i^{n-i}\\
 \\
\end{align*}
Since for any $\tau,\sigma \in S_n$ we have $\tau\sigma \in A_n$ or $\tau\sigma \in S_n \setminus A_n$, the same reasons as in part (a) shows that $S_n$ is the symmetry group of $D+D'$ and $DD'$. Hence $D(f)+D'(f),D(f)D'(f) \in F$ and 
$$D_f(y)=(y-D(f))(y-D'(f))=y^2-(D(f)+D'(f))y+D(f)D'(f)\in F[y].$$
The discriminant of $D_f(y)$ is $(D(f)-D'(f))^2=\Delta(f)=\prod_{1\leq i<j\leq n}(\alpha_i-\alpha_j)^2$.
\item[(d)] As per Theorem 7.4.1 and since, as per part (c), $D(f)+D'(f) \in F$, 
\begin{align*}
G_f \subset A_n & \iff \Delta (f) \in F^2 \iff (D(f)-D'(f)) \in F \iff D(f),D'(f) \in F\\
& \iff D_f(y) \mathrm{~splits~over~F}.
\end{align*}
\ee
\end{proof}
}
...
\begin{proof}
\be
\item[(a)] The following Sage instruction :
\begin{verbatim}
    ...
    S1=S1*S.subs(x1=x2,x2=x3,x3=x1)*S.subs(x1=x3,x2=x1,x3=x2)
    S=S1*S.subs(x1=x3,x2=x2,x3=x1)
    f=S.reduce(G).subs(y1=-1, y2 = -2,y3=1);show(f.factor())
\end{verbatim}
gives output the same as in Example 13.4.3:
\begin{align*}
s_u(y)=& (-y^3 - y^2u_1 + 2yu_1^2 + u_1^3 - y^2u_2 - 3yu_1u_2 - 4u_1^2u_2 + 2yu_2^2 + 3u_1u_2^2 + u_2^3 - y^2u_3\\ & - 3yu_1u_3 + 3u_1^2u_3 - 3yu_2u_3 - u_1u_2u_3 - 4u_2^2u_3 + 2yu_3^2 - 4u_1u_3^2 + 3u_2u_3^2 + u_3^3)\cdot \\
&   (-y^3 - y^2u_1+ 2yu_1^2 + u_1^3 - y^2u_2 - 3yu_1u_2 + 3u_1^2u_2 + 2yu_2^2 - 4u_1u_2^2 + u_2^3 - y^2u_3\\
& - 3yu_1u_3 - 4u_1^2u_3 - 3yu_2u_3  - u_1u_2u_3 + 3u_2^2u_3 + 2yu_3^2 + 3u_1u_3^2 - 4 u_2u_3^2 + u_3^3)\\
&=(u_1^3+3u_1^2u_2-4u_1u_2^2+u_2^3-4u_1^2u_3-u_1u_2u_3+3u_2^2u_3+3u_1u_3^2\\&-4u_2u_3^2+u_3^3+2u_1^2y-3u_1u_2y+2u_2^2y-3u_1u_3y-3u_2u_3y+2u_3^2y\\&-u_1y^2-u_2y^2-u_3y^2-y^3) \times (u_1^3-4u_1^2u_2+3u_1u_2^2+u_2^3+3u_1^2u_3\\&-u_1u_2u_3-4u_2^2u_3-4u_1u_3^2+3u_2u_3^2+u_3^3+2u_1^2y-3u_1u_2y\\&+2u_2^2y-3u_1u_3y-3u_2u_3y+2yu_3^2-u_1y^2-u_2y^2-u_3y^2-y^3)
\end{align*}
...
\begin{verbatim}
    ...
    S1=S1*S.subs(x1=x2,x2=x3,x3=x1)*S.subs(x1=x3,x2=x1,x3=x2)
    S=S1*S.subs(x1=x3,x2=x2,x3=x1)
    h=(-1)*S.reduce(G).subs(y1=-1, y2 = -2,y3=1).factor()[1][0]
    show(h)
\end{verbatim}
gives output for the first factor of $s_u(y)$, given in Example 13.4.3, multiplied by -1:
\begin{align*}
h=& y^{3} + y^{2} u_{1} - 2 y u_{1}^{2} - u_{1}^{3} + y^{2} u_{2} + 3 y u_{1} u_{2} - 3 u_{1}^{2} u_{2} - 2 y u_{2}^{2} + 4 u_{1} u_{2}^{2} - u_{2}^{3} + y^{2} u_{3}\\ & + 3 y u_{1} u_{3} + 4 u_{1}^{2} u_{3} + 3 y u_{2} u_{3} + u_{1} u_{2} u_{3} - 3 u_{2}^{2} u_{3} - 2 y u_{3}^{2} - 3 u_{1} u_{3}^{2} + 4 u_{2} u_{3}^{2} - u_{3}^{3}
\end{align*}
The additional Sage instruction: 
\begin{verbatim}
    h=h.subs(u_1=x1,u_2=x2,u_3=x3)
    h=h.reduce(G).subs(y1=sigma_1, y2 = sigma_2,y3=sigma_3)
        .subs(x1=u_1, x2=u_2,x3=u_3)
    h=h-7*sigma_3+sigma_1^3
    h=h.subs(sigma_1=u_1+u_2+u_3, sigma_2=u_1*u_2+u_2*u_3+u_3*u_1
        ,sigma_3=u_1*u_2*u_3).collect(y)
    h=h-h.subs(y=0)+h.subs(y=0).expand()+(7*sigma_3-sigma_1^3)
        .subs(sigma_1=u_1+u_2+u_3,sigma_3=u_1*u_2*u_3)
    show(h)
\end{verbatim}
gives the formula for h as a polynomial in y given in Example 13.4.3:
\begin{align*}
h&= -(u_{1} + u_{2} + u_{3})^{3} + 7 u_{1} u_{2}^{2} + 7u_{1}^{2} u_{3} + 7u_{1} u_{2} u_{3} + 7u_{2} u_{3}^{2}\\ &  + (u_{1} + u_{2} + u_{3}) y^{2} + y^{3} - (2(u_{1} + u_{2} + u_{3})^{2} - 7u_{1} u_{2} - 7 u_{1} u_{3} - 7u_{2} u_{3}) y\\ 
& =y^{3}+ (u_{1} + u_{2} + u_{3}) y^{2} + (7(u_{1} u_{2} + u_{1} u_{3} + u_{2} u_{3})-2(u_{1} + u_{2} + u_{3})^{2}) y\\ 
