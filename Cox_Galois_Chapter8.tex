...
By Proposition 7.1.7, the Galois closure exists: let $M$ a Galois closure of $F \subset K_1K_2$, and $\sigma$ any element of $\Gal(M/F)$.
...
\be
\item[$\bullet$] $1^m = 1$, donc $1\in \mathbb{U}_m \neq \emptyset$.

\item[$\bullet$] Si $\alpha, \beta \in \mathbb{U}_m$, alors $(\alpha \beta^{-1})^m = \alpha^m (\beta^m)^{-1} = 1$, donc $\alpha \beta^{-1} \in \mathbb{U}_m$.
\ee
