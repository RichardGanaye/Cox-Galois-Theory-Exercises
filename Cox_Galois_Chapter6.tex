...
If we suppose that $ [\Q(\zeta_n):\Q]= \phi(n)$,  $\varphi$ is an injection between two set of same cardinality, thus $\varphi$ is a bijection, and so $\varphi$ is a group isomorphism. Conversaly, if $\varphi$ is a group isomorphism, then $ [\Q(\zeta_n):\Q] = \Gal(\Q(\zeta_n)/\Q)\vert = \phi(n)$
